...
Record all the steps used to process the data and save the raw data. Using R is a good way to record all of the steps since we can save all the scripts we used, and we will not change the raw data processing in R. This keeps raw data safe. Besides, adding a comment line at the beginning of every program makes communication between different users easier.  
